...
#define UC3_RPMSG_MEM_BASE (0x2e1000000U)
...
#define CFG_VRING0_BASE0    (0x2e1000000U)
#define CFG_VRING1_BASE0    (0x2e1050000U)
#define CFG_VRING_SIZE0     (VRING_SIZE)
#define CFG_VRING_ALIGN0    (0x100U)
#define CFG_RPMSG_NUM_BUFS0 (512U)
#define CFG_VRING_SHM_BASE0 (0x2e1200000U)
#define CFG_VRING_SHM_SIZE0 (VRING_SHM_SIZE)
#define CFG_VRING_CTL_NAME0 "2e1000000.vring-ctl0"
#define CFG_VRING_SHM_NAME0 "2e1200000.vring-shm0"
#define VRING_NOTIFYID0     (0U)
// RPMSG channel #1
#define CFG_RPMSG_SVC_NAME1 "rpmsg-service-1"
#define CFG_VRING0_BASE1    (0x2e1100000U)
#define CFG_VRING1_BASE1    (0x2e1150000U)
#define CFG_VRING_SIZE1     (VRING_SIZE)
#define CFG_VRING_ALIGN1    (0x100U)
#define CFG_RPMSG_NUM_BUFS1 (512U)
#define CFG_VRING_SHM_BASE1 (0x2e1500000U)
#define CFG_VRING_SHM_SIZE1 (VRING_SHM_SIZE)
#define CFG_VRING_CTL_NAME1 "2e1100000.vring-ctl1"
#define CFG_VRING_SHM_NAME1 "2e1500000.vring-shm1"
